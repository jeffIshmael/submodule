...
const BuyerDashboard = () => {
  ...
  const handleTokenSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const etherAmount = Amount / 100000; // Calculate the Ether amount to send
    console.log(Amount);
    try {
      const hash = await writeContractAsync({
        ...
        functionName: "getCBT",
        args: [Amount],
        value: ethers.parseUnits(etherAmount.toString(), "wei"),
      });
        ...
        >
            ...
            <div className="flex top-4 w-80 right-4 bg-white p-4 rounded-lg shadow-md mt-50">
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="text-lg font-bold text-black">Purchase CBT</h2>
                  <small>
                    <span className="font-italic">NB:</span> Price of 1 CBT is
                    equal to 0.001 ethers
                  </small>
                  <div className="flex space-x-1">
          ...
          font-semibold capitalize"
              ...
              >
                ...
                <span>{Number(cred.estAmount) / 10 ** 18} CBT</span>
              </a>
            );
          })}
        </aside>
